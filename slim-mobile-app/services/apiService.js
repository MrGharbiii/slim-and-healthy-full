...
export const AnalysisAPI = {
  ...
  /**
   * Get user's plan data from the API
  ...
  async getUserPlan() {
    ...
    try {
      console.log('====================================');
      console.log('📋 USER PLAN FETCH START');
      console.log('====================================');
      console.log('📋 Timestamp:', startTime);
      console.log('====================================');

      const response = await apiRequest(API_ENDPOINTS.GET_USER_PLAN, {
        method: 'GET',
      });
      ...
      const endTime = new Date().toISOString();
      console.error('====================================');
      console.error('❌ USER PLAN FETCH FAILED');
      console.error('====================================');
      console.error('❌ End Timestamp:', endTime);
      console.error('❌ Error:', error.message);
      console.error('❌ Stack trace:', error.stack);
